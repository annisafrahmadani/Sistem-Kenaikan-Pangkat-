...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('config/proses_pendidikan') ?>?add">
    ...
    <div class="card-footer">
        <button href="<?= base_url('data/pendidikan') ?>" type="submit" class="btn btn-success float-right"><i class="fas fa-fw fa-save"></i> Simpan</button>
    </div>
    </form>
</div>
