...
<div class="card-header py-3">
    <a href="<?= base_url('pangkat') ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i> Tambah Pegawai</a>
</div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('edit_pangkat') ?>?id=<?= $pangkat['id_pangkat'] ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?= base_url('config/proses_pangkat') ?>?set&id=<?= $pangkat['id_pangkat'] ?>&nip=<?= $nip ?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Setup</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
